// CAudioEndpointVolumeCallback.h -- Implementation of IAudioEndpointVolumeCallback interface
...
public:
    ...
    HRESULT STDMETHODCALLTYPE OnNotify(PAUDIO_VOLUME_NOTIFICATION_DATA pNotify)
    {
        ...
        {
            printf_s("IsMuted:%d MasterVolume:%d\n", pNotify->bMuted, (UINT32)(MAX_VOL * pNotify->fMasterVolume + 0.5f));
